...
export function Marketplace() {
  ...
  // Sửa hàm đóng modal để reload marketplace
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gray-900 rounded-lg p-6 mb-8">
                          ...
                          <li key={rarity}>
                            <button
                              className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-700 ${
                                rarityFilter === rarity ? "text-purple-400" : ""
                              }`}
                              onClick={() => {
                  ...
                  <div className="absolute right-0 mt-1 bg-gray-800 rounded-md shadow-lg z-10 w-48">
                    <ul>
                      <li>
                        <button
                          className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-700 ${
                            sortOption === "price-low" ? "text-purple-400" : ""
                          }`}
                          onClick={() => {
                      ...
                      <li>
                        <button
                          className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-700 ${
                            sortOption === "price-high" ? "text-purple-400" : ""
                          }`}
                          onClick={() => {
                      ...
                      <li>
                        <button
                          className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-700 ${
                            sortOption === "rarity" ? "text-purple-400" : ""
                          }`}
                          onClick={() => {
                      ...
                      {activeSection === "myListings" && (
                        <li>
                          <button
                            className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-700 ${
                              sortOption === "newest" ? "text-purple-400" : ""
                            }`}
                            onClick={() => {
          ...
          <div className="text-sm text-gray-400 mb-4">
            ...
            {activeCategory === "all" ? "items" : activeCategory} in{" "}
